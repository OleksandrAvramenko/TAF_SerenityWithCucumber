...
public class UserManager {
    ...
    public static User getUser(final UserType userType) {
        ...
        switch (userType) {
            case STANDARD_USER:
                user = new User(ConfigurationManager.getProperty(STANDARD_USER_NAME), ConfigurationManager.getProperty(STANDARD_USER_PASSWORD));
                break;
            ...
            case EMPTY_PASSWORD_USER:
                user = new User(ConfigurationManager.getProperty(STANDARD_USER_NAME), "");
                break;
